...
//  2. Maps response body to schema attributes. After the method reads the coffees,
//     it maps the []hashicups.Coffee response to coffeesModel so the data source
//     can set the Terraform state.
